...
<@header title="${config.siteName!} | 欢迎光临"
            ...
            <div class="scrolltext">
                <ul class="list-unstyled" id="notice-box">
                    <li class="scrolltext-title">
                        <a href="javascript:void(0)" rel="bookmark">本站正式启用新域名:<a href="http://www.lihaineng.com/" target="_blank"><strong>http://www.lihaineng.com/</strong></a></a>
                    </li>
                    <li class="scrolltext-title">
