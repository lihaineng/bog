<nav id="topmenu" class="navbar navbar-default navbar-fixed-top">
    <div class="menu-box">
        ...
        <div class="menu-topmenu-container pull-right">
            ...
            <#else>
                <ul class="list-unstyled list-inline pull-left">
                    <li><a href="${config.cmsUrl}" rel="nofollow" title="授权登录">登录</a></li>
                </ul>
            </#if>
        </div>
    </div>
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        <@zhydTag method="tagsList" pageSize="10">
                                            <#if tagsList?? && (tagsList?size > 0)>
                                                <#list tagsList as node>
                                                    <#--<#if item.id = node.typ_id>-->
                                                        <li><a href="/tag/${node.id?c}" title="点击查看《${node.name!}》的文章">${node.name!}</a></li>
                                                    <#--</#if>-->
                                                </#list>
                                            </#if>
                                    </ul>
